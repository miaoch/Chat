        ...
        if (readObject != null && readObject instanceof TranObject) {
            ...
            switch (read_tranObject.getType()) {
                ...
                case LOGIN:
                    ...
                    userId = read_tranObject.getFromUser();
                    break;
                ...
                case MESSAGE:// 如果是转发消息（可添加群发）
                    ...
                    int sender = read_tranObject.getFromUser();
                    ...
                    if (toOut != null) {// 如果用户在线
                        ...
                        toOut = map.getById(sender);
                        TranObject msg = new TranObject<String>();
                        msg.setType(TranObjectType.MESSAGE);
                        msg.setObject("该用户不在线哦！");
                        toOut.sendMessage(msg);
                    }
                    break;
                case REFRESH:
                    break;
